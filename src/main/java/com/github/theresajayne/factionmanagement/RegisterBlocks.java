...
public class RegisterBlocks {
    ...
    {
        FactionManagement.claimBlock = new GenericBlock(Material.rock).setHardness(50.0F).setStepSound(Block.soundTypeMetal).setBlockName("claimBlock").setCreativeTab(CreativeTabs.tabMisc).setBlockTextureName("generic:ClaimBlock");
